...
class FilesystemService:
    ...
    def update_files(
        ...
        return self._gateway.update_files(files, line_intervals=line_intervals)
    ...
    def copy_or_move_files(
        ...
        return self._gateway.copy_or_move_files(
    ...
    def update_directories(
        ...
        return self._gateway.update_directories(
            sources=sources, destination=destination, move=move
        )
    ...
    def search_directories(
        ...
        return self._gateway.search_directories(
    ...
    def copy_or_move_directories(
        ...
        return self._gateway.copy_or_move_directories(
            paths=paths, destination=destination, move=move
        )
